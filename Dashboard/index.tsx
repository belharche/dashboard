...
import { CogIcon, BellIcon, UserIcon, CalendarIcon, CollectionIcon, CreditCardIcon, MenuIcon, XIcon } from '@heroicons/react/solid';
...
function Dashboard() {
  ...
  const sidebarButtons: SidebarButtons[] = [
    ...
    { icon: <BellIcon className="w-5 h-5 mr-2" />, label: 'Notifications' },
  ...
  return (
    <div className="flex min-h-screen p-2 gap-2 bg-beige-primary-bg overflow-hidden">
